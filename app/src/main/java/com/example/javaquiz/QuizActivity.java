...
public class QuizActivity extends AppCompatActivity {
    ...
    private TextView txtScore, txtQuestionLeft, txtTimer, txtQuestion, txtHighScore;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textColorDefaultCd = txtTimer.getTextColors();
    ...
    private void nextQuestion() {
        ...
        if(questionCounter < questionCountTotal) {
            ...
            questionCounter++;
            txtQuestionLeft.setText("Question: " + questionCounter + "/" + questionCountTotal);
            answered = false;
    ...
    private void updateCountDownText() {
        ...
        if (timeLeftInMillis < 10000) {
            ...
            txtTimer.setTextColor(textColorDefaultCd);
        }
    }
    ...
    private void initViews() {
        ...
        txtQuestionLeft = findViewById(R.id.txtQuestionLeft);
